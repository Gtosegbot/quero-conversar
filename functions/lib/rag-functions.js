...
exports.reprocessAllPDFs = exports.onPDFDeleted = exports.processUploadedPDF = exports.chatWithDraClara = void 0;
 ...
 */
exports.processUploadedPDF = functions.storage.object().onFinalize(async (object) => {
 ...
 */
exports.onPDFDeleted = functions.storage.object().onDelete(async (object) => {
    const filePath = object.name;
    if (!filePath?.startsWith('knowledge_base/')) {
        return null;
    }
 ...
 */
exports.reprocessAllPDFs = functions.https.onCall(async (data, context) => {
