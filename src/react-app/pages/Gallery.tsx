...
const Gallery: React.FC = () => {
    ...
    const handlePurchaseClick = (item: ContentItem) => {
        if (item.isPaid) {
            setSelectedProduct(item);
        } else {
            window.open(item.videoUrl || item.link || item.url, '_blank');
        }
    };
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                                        ...
                                        <button
                                            ...
                                            className={`font-medium text-sm flex items-center transition-colors ${item.isPaid
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
                            ...
                            <div className="bg-green-50 rounded-lg p-4 mb-6 border border-green-100">
                                <h4 className="font-bold text-lg text-green-900 mb-1">{selectedProduct.title}</h4>
                                <p className="text-green-700 text-sm">{selectedProduct.description}</p>
                            ...
                            <div className="space-y-4">
                                <div className="text-sm text-gray-600">
                                    <p className="font-bold mb-2">Instruções para pagamento via PIX:</p>
                                    <p>1. Utilize a chave PIX abaixo para realizar o pagamento.</p>
                                    <p>2. Envie o comprovante para nosso WhatsApp.</p>
                                    <p>3. Seu acesso será liberado imediatamente após a confirmação.</p>
                                </div>
                                ...
                                <button
                                    ...
                                    className="block w-full text-center text-gray-500 py-2 hover:text-gray-700 text-sm"
                                >
                                    Cancelar
                                </button>
                            </div>
